...
<h3 class="text-danger"></h3>
        ...
        <button type="submit" style="font-size:20px" class="btn btn-warning"  name="login"><a href="http://localhost//fullproject/articles.php" style="color: black; text-decoration: none;"> Back </a></button>  
        </div>
        </div>
